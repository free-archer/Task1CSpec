...
- Если пользователь после проверки текущей спецификации пишет `согласовано`, `согласовал` или `соглаовал`, зафиксируй согласование текущего этапа и не создавай новую спецификацию в этом же ответе.
...
- Перед созданием спецификации следующего этапа убедись, что спецификация предыдущего этапа согласована. Если согласования нет, остановись и попроси пользователя проверить предыдущий файл и написать `согласовано`, `согласовал` или `соглаовал`.
- Факт согласования фиксируй в конце соответствующей спецификации строкой `Согласовано : <текущая дата и время>. Согласовал: <имя> (<роль>).`
- Имя и роль согласующего бери из файла `.settings`. Если `.settings` отсутствует или в нем нет нужных значений, явно укажи `не указано`.
- В `КарточкаЗадачи.md` веди журнал всех этапов с отметками времени: создание/обновление спецификации, отправка на проверку, согласование, переход к следующему этапу, начало разработки кода, обновление документации и архивация.
